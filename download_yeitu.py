...
def parse_page(url):
    resp = requests.get(url, headers=HEADERS, proxies=PROXY, timeout=10)
    html = etree.HTML(resp.text)
    html_urls = html.xpath('/html/body/div[5]/div[1]/ul/li/a/@href')
...
if __name__ == '__main__':
    for page in range(10, 84):
        # 117
        url = f'https://www.yeitu.com/meinv/wangluomeinv/{page}.html'
